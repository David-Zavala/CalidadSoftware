...
#archivos = ["askForDof.py","askForX.py","CalculateIntegrateBySimpsonsRule.py","convertToFloat.py","convertToInt.py","extractCant.py","fileExists.py","GetSumEvens.py","GetSumOdds.py","Gamma.py","hasCharIn.py","IntegrateWithSimpsonsRule.py","isBlank.py","isNumber.py","removeCommas.py","SaveResultInCache.py","SimpsonsRuleIntegration.py","TDistributionPDF.py"]
archivos = []

contenido_carpeta = os.listdir(path)
for elemento in contenido_carpeta:
    ruta_elemento = os.path.join(path, elemento)
    if os.path.isfile(ruta_elemento) and ruta_elemento != ".DS_S":
